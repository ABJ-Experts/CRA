...
- Name: tenant-administration.spec.ts >> an owner opens tenant administration and persists catalog-backed settings
- Location: e2e/tenant-administration.spec.ts:145:1
