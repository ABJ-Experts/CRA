...
- Name: m2-v2-compliance.spec.ts >> a run-scoped owner sees the flagged badge, reviews assessment history, rejects a quarantined artifact, and hits a stale metadata-edit conflict
- Location: e2e/m2-v2-compliance.spec.ts:465:1
