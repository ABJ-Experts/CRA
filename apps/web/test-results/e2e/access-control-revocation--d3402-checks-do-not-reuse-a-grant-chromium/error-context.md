...
- Name: access-control.spec.ts >> revocation is immediate, outages stay visible, and restored checks do not reuse a grant
- Location: e2e/access-control.spec.ts:9:1
