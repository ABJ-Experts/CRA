insert into public.organization_export_source_tables(
  ...
  ('sbom_normalized_graph', 'organization_sbom_quality_settings', 'organization_id', 'organization_id', 6),
  ('sbom_normalized_graph', 'sbom_quality_reports', 'organization_id', 'id', 7),
  ('sbom_normalized_graph', 'sbom_quality_findings', 'organization_id', 'id', 8)
...
begin
  lock table
    ...
    public.sbom_component_dependencies, public.organization_sbom_quality_settings,
    public.sbom_quality_reports, public.sbom_quality_findings
  in share mode;
