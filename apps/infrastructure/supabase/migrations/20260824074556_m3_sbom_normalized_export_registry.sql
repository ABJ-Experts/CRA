...
values ('sbom_normalized_graph',true,34)
...
insert into public.organization_export_source_tables(
  ...
  ('sbom_normalized_graph', 'sbom_documents', 'organization_id', 'id', 1),
  ('sbom_normalized_graph', 'sbom_document_sources', 'organization_id', 'id', 2),
  ('sbom_normalized_graph', 'sbom_components', 'organization_id', 'id', 3),
  ('sbom_normalized_graph', 'sbom_component_identities', 'organization_id', 'id', 4),
  ('sbom_normalized_graph', 'sbom_component_dependencies', 'organization_id', 'id', 5)
...
begin
  lock table
    ...
    public.connectors, public.product_external_identities, public.field_authority_policies,
    public.sync_runs, public.sync_run_plan_items, public.sync_conflicts,
    public.sync_connector_cursors, public.sbom_documents, public.sbom_document_sources,
    public.sbom_components, public.sbom_component_identities,
    public.sbom_component_dependencies
  in share mode;
