-- Reapply the shared content-addressed reservation function for databases that
-- already applied the prior migration while the reserve RPC still contained the
-- earlier artifact-id path shape.
