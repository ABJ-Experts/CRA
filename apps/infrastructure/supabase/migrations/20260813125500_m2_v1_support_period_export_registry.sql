-- Support-period decisions are compliance records. Register their immutable
-- history in the existing tenant export source and lock it into snapshots.
...
insert into public.organization_export_source_tables (
  ...
  'product_registry', 'product_support_periods', 'organization_id', 'id', 7
